  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 font-sans">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl shadow-gray-200/50 p-10 border border-gray-100">
        ...
        <p className="text-center text-gray-400 text-xs font-bold uppercase tracking-widest mb-10">Control Central</p>
        ...
        <p className="mt-8 text-center text-xs font-bold text-gray-400 uppercase tracking-widest">
          ¿No tienes cuenta? <Link to="/register" className="text-emerald-600 hover:text-emerald-500 transition-colors ml-2">Regístrate</Link>
        </p>
      </div>
    </div>
  );
